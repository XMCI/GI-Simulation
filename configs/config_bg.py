...
outputFilename = 'bg'   # output file name, with the extension '.npy' or 'npz'
...
responseFile = 'spectrums/ER_60.mat'  # file path of the detector response, variable name as 'ER'; 
noiseFlag = 0           # flag for adding poisson noise, 1 or 0

# Phantom parameters
phantomFlag = 0          # flag for if a phantom is used, 1 or 0
propaMode = 'projection_approxi' # mode of propagation, 'projection_approxi' or 'mult_slice'
phantom = 'Sph_40.0um_0.4'           # mat file saved in ./phantom
phantomMaterial = 'PMMA'   # symbol of phantom material
disSG2 = 0.2             # distance between sample (the side close to g2) and g2, unit: m
...
propagationType = 'fresnel'              # specified propagation type, just 'fresnel'
